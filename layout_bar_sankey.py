...
def get_card(card_id, color, font_size="1rem"):
    return dbc.Card(
        [
            dbc.CardBody(
                [
...
def get_KPIrow():
    KPIrow = html.Div(
        [  # Internal row
            html.Div(
                [get_card("nbd_name", dashboard_colors["acid-pink"], "3rem"),],
                className="col-3",
            ),
            html.Div(
            ...
            [
                html.Div(  # Start of div with 2-col for filters and 9 col for graphs split
                    [
                        get_filterbar(),
                        html.Div(
                            # This column is to be shared by 2 charts
                            [
                                html.Div(
                                    [
                                        get_KPIrow(),
                ...
                html.Div(  # Start of div just two column charts
                    [
                        html.Div(
                            [get_barsankeyrow()],
                            className="col-12",
